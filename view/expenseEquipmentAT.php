  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><i class="fa fa-list-ul"></i>Expense Equipments</li> 
			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content">
						...
						?>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsExpeneseEquipmentsAT.php" method="POST">
							...
							<div class="alert" style="background-color: #efeaea;">
								...
								<div class="form-group">
									...
									<div class="col-lg-1 col-md-2 col-sm-3"> 
										<select class="select2 form-control" name='itemUnit[]' onchange='selectExistAmountAndPrice(<?php  echo $i; ?>)' autocomplete="off" id='itemUnit-<?php echo $i; ?>'>
									...
									<div class="col-lg-2 col-md-4 col-sm-5"> 
										<input type="text" placeholder="Quantity" autocomplete="off" onKeyPress="return isNumericKey(event)"  onkeyup="calculateTotalAmountFee(this.id)"  ondblclick = "getExistanceStock(<?php   echo $i; ?>)" id="amount-<?php echo $i; ?>" name="amount[]" class="form-control p-number">
										<p class="help-block"></p>
									</div> 
									
									<div class="col-lg-1 col-md-2 col-sm-3"> 
										<input type="text" placeholder="Unit Price" autocomplete="off" onKeyPress="return isNumericKey(event)"   onkeyup="calculateTotalAmountFee(this.id)" id="fee-<?php echo $i; ?>" name="fee[]" class="form-control">
										<p class="help-block"></p>
									</div> 
									
									<div class="col-lg-1 col-md-2 col-sm-6"> 
										<input type="text" placeholder="Total Amount" autocomplete="off" onKeyPress="return isNumericKey(event)"  onkeyup="calculateTotalAmountFee(this.id)" id="totalFee-<?php echo $i; ?>" name="totalFee[]" class="form-control totalFee">
										<p class="help-block"></p>
									</div> 
						...
						<?php
							...
							listExpenseEquipments('expenseEquipmentAT.php',$validationEditCondition,$validationRemoveCondition);
...
function selectItemUnit(itemId,rowId){
 ...
 function selectExistAmountAndPrice(rowId){
	var itemId  = $("#itemId-"+rowId).val();
	var stockId  = $("#stockId-"+rowId).val();
	$.post("AjaxExistedStockAmountAddPrice.php",{"itemId":itemId,"stockId":stockId},function(data){
		var splitResult = data.split("-");
		var existAmount  = splitResult['0'];
		var fee  = splitResult['1'];
		$("#amount-"+rowId).val(existAmount);
		$("#fee-"+rowId).val(fee);
		var total  = parseFloat(existAmount) * parseFloat(fee);
		
		$("#totalFee-"+rowId).val(total);
	}); 
}
