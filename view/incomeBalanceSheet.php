<?php
	require_once("_header.php");
  	$formHeader  = "Miscellaneous Income";
		...
		<div class="main-content">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
					<h1 class="text-center"><?php echo $companyName; ?></h1>
						...
						if(!empty($fromDate) && !empty($toDate)){
							$title="Miscellaneous Income From <b> ".$fromDate."  </b> to <b>".$toDate."</b>";
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php
						$table      = "tbl_incomes";       
						$targetPage = "incomeBalanceSheet.php";    
						$limit      = 40;  
						if(!empty($fromDate) && !empty($toDate)){
						...
						<table  class="table table-bordered table-hover" id ="example" >
							...
							<tbody>
								...
								$serviceProviderId = $row['id'];
									...
									?>
									<tr>
										<td class='text-center' colspan='7' ><b>Total Miscellaneouse Income</b></td>
