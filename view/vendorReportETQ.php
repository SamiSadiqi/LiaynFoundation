					...
					<div class="panel-body" id="page-content"> 
						 <div class="row">
							...
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3 col-lg-offset-3 col-md-offset-2 col-sm-offset-2">
								<a  href="vendorCategoryReports.php"  target="_blank">
									<img src="../assets/icons/report.png" class="img-circle img-rotate" />
									<div class="margin-top-10"></div>
									<h4 class="text-center" >Vendor's Category</h4>
								</a>
							</div>
							...
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3">
 								...
 								<a href="vendorCurrencyReportsAT.php"  target="_blank">
									<img src="../assets/icons/document.png" class="img-circle img-rotate" />
									<div class="margin-top-10"></div>
									<h4 class="text-center">Vendor's Loan</h4>
								</a>
								
							</div>
							
							<div class="col-lg-2 col-md-2 col-sm-2 col-xs-3">
								<a  href="vendorsInvoicesListReportsAT.php" target="_blank">
									<img src="../assets/icons/expensesApproval.png" class="img-circle img-rotate" />
									<div class="margin-top-10"></div>
									<h4 class="text-center">Vendor's Invoice List</h4>
								</a> 
							</div>
							<!---
							<div class="col-lg-2 col-md-2 col-sm-2  col-xs-3 ">
								<a href="vendorListReportAT.php"  target="_blank">
									<img src="../assets/icons/transaction.png" class="img-circle img-rotate" />
									<div class="margin-top-10"></div>
									<h4 class="text-center">Vendor List (Extra Page)</h4>
								</a>
							</div>
							--->
						</div>
