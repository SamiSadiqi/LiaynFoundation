				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						<form class="form-horizontal"  id="insertForm" method="POST">
							...
							<input name="formTable" value="<?php echo encryptIt("tbl_school_managers"); ?>" type="hidden"  />
							
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="date">تاریخ ثبت</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="تاریخ" autocomplete="off" id="date" name="date" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
	
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="name">نام مدیر</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="نام مدیر" autocomplete="off" id="name" name="name" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
						...
						<?php
							...
							schoolManagersTable('addManagerAT.php',$validationEditCondition,$validationRemoveCondition);
...
$(document).on('click','#insertId',function(){ 
	...
	$.post("insertDataAT.php",$('#insertForm').serialize(),function(data){
		if(data == 'save'){
			$('#save').removeClass('hide').fadeIn(1000).fadeOut(2000)
			...
			$('#duplicate').removeClass('hide').fadeIn(1000).fadeOut(2000)
