  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><i class="fa fa-list-ul"></i>Definition</li> 
			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
 					...
 					<BR>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsPositionAT.php" method="POST">
							
							<input name="formParameter" value="<?php echo encryptIt("insertPositionAT"); ?>" type="hidden"  />
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="Action Name" autocomplete="off" required id="name" name="name" class="form-control">
						...
						<?php
							...
							listPosition($validationEditCondition,$validationRemoveCondition);
...
function readCurrencyRate(){
	$.post("AjaxReadCurrenies.php",{"currenciesId":144},function(data){
		$("#rate").val(data);
	});
}
 </script>
