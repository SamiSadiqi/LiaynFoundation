			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						?>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsAddCurrencyETQ.php" method="POST">
						
							<input name="formParameter" value="<?php echo encryptIt("insertCurrencyETQ"); ?>" type="hidden"  />
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<select class="select2 form-control" name='currencyId' autocomplete="off" id='currencyId'>
									    	<option Value="">انتخاب نوع واحد پولی</option>
											<?php
											 
 											$currencyRow= $conn->query("SELECT * FROM `tbl_currencies`  ORDER BY id DESC");
						...
						<?php
							 ...
							 listCurrencies($validationRemoveCondition);
