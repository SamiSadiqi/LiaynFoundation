<?php 
	...
	$objPHPExcel =  new PHPExcel();
 	$objPHPExcel = PHPExcel_IOFactory::load("../excelTemplateReports/vendorCashPaymentReport.xls");

	$table="tbl_vendor_payment";
		$i=5;
		$count=1;
	$selectDate    = "SELECT * FROM $table WHERE  deleted = 0  AND payment_type = 1 ORDER BY id DESC";
	...
	header('Content-Disposition: attachment;filename="VendorCashPaymentReports.xls"');
