<?php
	...
	$menu = "vendorsAT";
	$formHeader  = "ویرایش جزئیات فاکتور";
?>
  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><i class="fa fa-list-ul"></i>خریداری</li> 
				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<?php
						...
						if($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])){
							...
							editVendorsDetails($id,$validationEditCondition,$validationRemoveCondition);
						}else{
 							header("location: purchasesBillAT.php");
							exit();
						}
