				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsEditPartialyUserETQ.php" method="POST"  enctype="multipart/form-data">
							...
							<input name="formParameter" value="<?php echo encryptIt("editPhotoETQ"); ?>" type="hidden"  />
							<input name="id" value="<?php echo encryptIt($userId); ?>" type="hidden"  />
							
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="photo">Upload Photo</label> 
