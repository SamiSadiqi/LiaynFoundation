					...
					<div class="panel-body" id="page-content"> 
						...
						<div class="table-responsive">
							<table class="table table-bordered border">
								<thead>
									<tr>
										<th class="text-center table-title" colspan="10">Editable Data</th>
									</tr>
								...
								<tbody> 
									<tr class='active'>
 										<td class='text-center' style="padding-top:20px;"><?php  echo $email; ?></td>
   									</tr> 
								</tbody> 
							</table>
						</div>
						...
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsEditPartialyUserETQ.php" method="POST"  enctype="multipart/form-data">
							...
							<input name="formParameter" value="<?php echo encryptIt("editEmailETQ"); ?>" type="hidden"  />
							<input name="id" value="<?php echo encryptIt($userId); ?>" type="hidden"  />
							
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="Email">Email</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="email" placeholder="Email" id="email" autocomplete="off" name="email" value="<?php  echo $email;   ?>" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
