<?php
	...
	$menu = "reportsAT";
 	$formHeader  = "Vendor's Invoices List";
		...
		<div class="main-content">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
					...
					<h3 class="text-center">Vendor's Loan List</h3>
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php
						...
						$targetPage = "vendorInvoceCategoryReportsAT.php";    
						$limit      = 40;  
						if($vendorId == 'all'){
 							 $rowCountQuery  = $conn->query("SELECT COUNT(*) AS totalRows FROM $table WHERE  deleted = 0 ORDER BY id DESC");
						}elseif($vendorId != 'all'){
 							 $rowCountQuery  = $conn->query("SELECT COUNT(*) AS totalRows FROM $table WHERE vendors_id = '$vendorId' AND deleted = 0 ORDER BY id DESC");

						}
						$rowCountSQL  = $rowCountQuery->fetch_array();
						...
						if($vendorId == 'all'){
							...
							$vendorsRawSQLQuery    = "SELECT * FROM $table WHERE deleted = 0 AND  vendors_id = '$vendorId' ORDER BY id DESC LIMIT $start, $limit";
						}
