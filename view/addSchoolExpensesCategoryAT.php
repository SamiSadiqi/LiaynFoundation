  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			<span>موفعیت فعلی</span>
			<!-- <li><a href="index.php"><i class="fa fa-home"></i>صفحه اصلی</a></li>  -->
			<li class="active"><i class="fa fa-list-ul"></i><strong>اجراء </strong></li> 
				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						<form class="form-horizontal"  id="insertForm" method="POST">
							...
							<input name="formTable" value="<?php echo encryptIt("tbl_org_expense_categories"); ?>" type="hidden"  />

							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="data">کتگوری مصارف مکاتب <span class="text-danger" style="font-size:20px;"> * </span></label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="کتگوری مصارف مکاتب" autocomplete="off" id="name" name="name" class="form-control">
						...
						<?php
							...
							schoolOrgExpensesCategoryTable($validationEditCondition,$validationRemoveCondition);
