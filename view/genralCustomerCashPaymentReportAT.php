<?php
	...
	$menu = "reportsAT";
 	$formHeader  = "Customer's Cash Payments Reports";
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php
						...
						$targetPage = "genralCustomerCashPaymentReportAT.php";    
						$limit      = 40;  
						if(!empty($fromDate) && !empty($toDate)){
					...
					<div class="panel-body table-responsive" id="page-content"> 
    					<div class="form-group dontPrint"> 
        					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
								...
								<form method="post" action="excelCustomerCashPaymentReportsAT.php">
