<?php 
	...
	$objPHPExcel =  new PHPExcel();
 	$objPHPExcel = PHPExcel_IOFactory::load("../excelTemplateReports/excelOrgConstructionEpensesAT.xls");
	...
	while($row=$selectDataQueryRow->fetch_array()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue("D$i",$rowExpenseCategory['name']);
		$objPHPExcel->getActiveSheet()->setCellValue("E$i",$rowMaterialsBanks['name']);
	...
	header('Content-Disposition: attachment;filename="ConstructionMaterialsExpense.xls"');
