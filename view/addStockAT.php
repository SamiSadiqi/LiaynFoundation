				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						?>
							...
							<input name="formTable" value="<?php echo encryptIt("tbl_stocks"); ?>" type="hidden"  />
							
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="name">نام گدام</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="نام گدام" autocomplete="off" required id="name" name="name" class="form-control">
						...
						<?php
							...
							listStocks('addStockAT.php',$validationEditCondition,$validationRemoveCondition);
