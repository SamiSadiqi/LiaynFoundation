<?php
	...
	$menu = "schoolsAT";
	$formHeader  = "ویرایش جزئیات درخواست اقلام ";
?>
					...
					<?php
						...
						if($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])){
							...
							$id = decryptIt($_GET['id']);
 							...
 							editOrgRequestMaterials($id,$validationEditCondition,$validationRemoveCondition);
						}else{
 							header("location: addOrganizationMaterialsRequestAT.php");
							exit();
						}
