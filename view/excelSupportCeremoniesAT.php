<?php 
	...
	$objPHPExcel =  new PHPExcel();
 	$objPHPExcel = PHPExcel_IOFactory::load("../excelTemplateReports/excelSupportCeremoniesRequestsAT.xls");
	...
	while($row=$selectDataQueryRow->fetch_array()){
		...
		$objPHPExcel->getActiveSheet()->setCellValue("D$i",$rowCeremonies['name']);
	...
	header('Content-Disposition: attachment;filename="SupportCeremoniesList.xls"');
