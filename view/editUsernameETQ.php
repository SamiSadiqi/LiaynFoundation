				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsEditPartialyUserETQ.php" method="POST"  enctype="multipart/form-data">
							...
							<input name="formParameter" value="<?php echo encryptIt("editUsernameETQ"); ?>" type="hidden"  />
							...
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="username">Username</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="Username / Email" id="username" autocomplete="off" value="<?PHP echo $username;   ?>" name="username" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div>
