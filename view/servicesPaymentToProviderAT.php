<?php
	...
	$menu = "sevicesAT";
	$formHeader  = "Service Payment Transaction";
  ?>
		...
		<div class="row">
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<?php
					//select Factor Id.
					$factorSql  = $conn->query("SELECT * FROM tbl_service_payment WHERE deleted = 0 AND payment_type = 2 ORDER BY id DESC");
					...
					<div class="panel-body" id="page-content"> 
						...
						?>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsServicesPaymentAT.php" method="POST">
						
							<input name="formParameter" value="<?php echo encryptIt("insertServicePaymentAT"); ?>" type="hidden"  />
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<select class="select2 form-control" name='providerId' onchange="selectProviderCurrency(this.value)"  autocomplete="off">
							...
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="paymentNumber">Payment Number</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text"  value="<?php  echo $factorNumber; ?>"   name='paymentNumber'  class="form-control" readOnly>
									<p class="help-block"></p>
								 </div> 
							</div> 
						...
						<?php
							...
							servicePaymentList("servicesPaymentToProviderAT.php",$validationEditCondition,$validationRemoveCondition);
