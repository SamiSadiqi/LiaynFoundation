<?php
	require_once("_header.php");
 	$formHeader  = "جزئیات درخواست های اقلام اجراء نشده";
...
<title><?php echo $pageTitle; ?></title>
 ...
 <div id="donationsItems" class="modal fade">
			...
			<div class="row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php
						...
						$targetPage = "preDonationListAT.php";    
						$limit      = 400000;  
								...
								$counter = $start;
									while($row = $incomesSQLQuery->fetch_array()){
										...
										<tr>
											...
											<td class="text-center"><a title="Edit Details" onclick="showDetails(<?php  echo $row['id']; ?>);"><i class="fa fa-edit btn btn-blue btn-outline"></i></a></td>
										</tr>
								<?php 
									}
								?>
...
function showDetails(titleId){
	...
	$.post("AjaxShowPreItemsDonationsDetailsAT.php",{"titleId":titleId},function(data){
		 $("#modalContent").html(data);
 		   $('#donationsItems').modal('show');
	});
}
