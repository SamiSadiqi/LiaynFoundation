<?php 
	...
	$objPHPExcel =  new PHPExcel();
 	$objPHPExcel = PHPExcel_IOFactory::load("../excelTemplateReports/incomeReportsExcel.xls");
	...
	$rowExpenseCategory = $conn->selectRecord ("tbl_income_categories","id  = ". $row['income_category_id']);
	$rowExpenseType = $conn->selectRecord ("tbl_income_types","id  = ". $row['income_type_id']);
	...
	header('Content-Disposition: attachment;filename="incomeExcelReports.xls"');
