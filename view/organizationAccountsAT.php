			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						 <form class="form-horizontal" action="executeOrganizationRequestAT.php" method="POST">
										
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="name">نام سازمان/ مکتب</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="نام مکتب/ سازمان" autocomplete="off" id="name" name="name" class="form-control">
...
jQuery(document).ready(function(){
    $("#name").keyup(function(){
         if($("#name").val()){
             $.ajax({
                url: 'AjaxOrganizationSearchAT.php',
                type: 'GET',
                data: {temp: $("#name").val()},
                dataType: 'html',
                beforeSend: function() {
