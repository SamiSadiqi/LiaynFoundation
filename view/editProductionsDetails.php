<?php
	...
	$menu = "factoryAT";
	$formHeader  = "Edit Raw Materials Which Used In Production";
?>
				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<?php
						...
						if($_SERVER['REQUEST_METHOD'] == "GET" && isset($_GET['id'])){
							...
							editProductionsDetails($id,$validationEditCondition,$validationRemoveCondition);
						}else{
 							header("location:factoryProductionAT.php");
							exit();
						}
