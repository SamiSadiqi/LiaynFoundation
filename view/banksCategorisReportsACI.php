  ...
  <div class="main-container">
	...
	<div class="main-content">
		...
		<ol class="breadcrumb breadcrumb-2"> 
			...
			<li class="active"><i class="fa fa-list-ul"></i>بانک ها</li> 
				...
				<div class="panel panel-primary animated fadeInUp">
					<div class="panel-heading clearfix"> 
						...
						<ul class="panel-tool-options"> 
							...
							<?php   goBackward('banksReportsAT.php');  ?>
						</ul> 
					</div> 
					<!-- panel body --> 
					<div class="panel-body" id="page-content"> 
						<form class="form-horizontal" action="bankCategoryReportsACI.php" method="POST">
											
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="unit">کتگوری بانک</label> 
								<div class="col-lg-6 col-md-8 col-sm-10">  
									<select class="select2 form-control" name='bankCategory' autocomplete="off" id='bankCategory'>
									    	<option Value="all">کتگوری بانک ها</option>
											<?php
