<?php 
	...
	$objPHPExcel =  new PHPExcel();
 	$objPHPExcel = PHPExcel_IOFactory::load("../excelTemplateReports/serviceTransactionAssetReport.xls");

	$table="tbl_service_provider";
		$i=5;
		$count=1;
	$selectDate    = "SELECT * FROM $table WHERE deleted = 0 AND transaction_type = 2 ORDER BY id DESC ";
	...
	header('Content-Disposition: attachment;filename="serviceTransactionAssetReports.xls"');
