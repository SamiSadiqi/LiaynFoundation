				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content">
						...
						<form class="form-horizontal"  id="insertForm" method="POST">
							<input name="formTable" value="<?php echo encryptIt("tbl_item_units"); ?>" type="hidden"  />

							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="name">واحد جنس<span class="text-danger" style="font-size:20px;"> * </span></label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="واحد جنس" autocomplete="off" id="name" name="name" class="form-control">
						...
						<?php
							...
							listItemUnits('addItemUnitAT.php',$validationEditCondition,$validationRemoveCondition);
