<?php 
	...
	$objPHPExcel =  new PHPExcel();
 	$objPHPExcel = PHPExcel_IOFactory::load("../excelTemplateReports/bankTransactionCreditedReport.xls");

	$table="tbl_bank_statement";
		$i=5;
		$count=1;
	$selectDate    = "SELECT * FROM $table WHERE deleted = 0 AND transaction_type = 1 AND place='Bank Transaction' ORDER BY id DESC ";
