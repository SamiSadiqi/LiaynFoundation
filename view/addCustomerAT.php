        ...
        <div class="modal-content">
			...
			<div id='feedback' style="margin:0 auto;text-align:center;width:50%;height:30px;border-radius:5px;margin-bottom:10px;padding-top:5px;color:black"></div>
				...
				<form class="form-horizontal" id="vendorCategory"  method="POST">
					<input name="table" value="<?php echo encryptIt("tbl_customer_categories"); ?>" type="hidden"  />

						<div class="form-group"> 
							<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="name">Category</label> 
							<div class="col-lg-6 col-md-8 col-sm-10"> 
								<input type="text" placeholder="Category" autocomplete="off" id="name" name="name" class="form-control">
			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						?>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsCustomerETQ.php" method="POST">
						
							<input name="formParameter" value="<?php echo encryptIt("insertCustomerETQ"); ?>" type="hidden"  />
							...
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="customerType">Customer Type</label> 
								<div class="col-lg-5 col-md-6 col-sm-7"> 
									<select class="select2 form-control" name='customerType' id="customerType"   autocomplete="off">
							...
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="contact">Contact / Email</label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="Contact / Email" autocomplete="off" name="contact" id="contact" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="Opening Balance" autocomplete="off" id="openingBalance" onKeyPress="return isNumericKey(event)"  name="openingBalance" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div>
						...
						<?php
							...
							listCustomers('addCustomerAT.php',$validationEditCondition,$validationRemoveCondition);
