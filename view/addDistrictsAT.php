				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						<form class="form-horizontal"  id="insertForm" method="POST">
							...
							<input name="formTable" value="<?php echo encryptIt("tbl_districts"); ?>" type="hidden"  />
							
						
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="name">ولسوالی / ناحیه <span class="text-danger" style="font-size:20px;"> * </span></label> 
