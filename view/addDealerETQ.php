			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						?>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>actionsDealerETQ.php" method="POST">
						
							<input name="formParameter" value="<?php echo encryptIt("insertDealerETQ"); ?>" type="hidden"  />
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="نام" autocomplete="off" id="name" name="name" required class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="تخلص" autocomplete="off" id="family" name="family" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
							
							<div class="form-group"> 
								<label class="col-lg-2 col-md-2 col-sm-2 col-lg-offset-2 col-md-offset-1 col-sm-offset-0 control-label" for="contact">شماره تماس <span class="text-danger" style="font-size:20px;"> * </span></label> 
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="شماره تماس" id="شماره تماس" autocomplete="off" required name="contact" class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div> 
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<textarea    placeholder = "توضیحات" autocomplete="off" name="address" name="address" class="form-control"></textarea>
 									<p class="help-block"></p>
								 </div> 
							</div>
						...
						<?php
							...
							listDealers("addDealerETQ.php",$validationEditCondition,$validationRemoveCondition);
