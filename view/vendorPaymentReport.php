 <?php
	...
	$menu = "vendorsAT";
	$formHeader  = "پرداختی ها به فروشنده";
?>
					...
					<div class="panel-body" id="page-content"> 
						<form class="form-horizontal" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">							
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="از تاریخ" autocomplete="off" id="date1" name="fromDate" data-select='datepicker'  class="form-control">
							...
							<div class="form-group"> 
								...
								<div class="col-lg-6 col-md-8 col-sm-10"> 
									<input type="text" placeholder="الی تاریخ" autocomplete="off" id="date" name="toDate"    class="form-control">
									<p class="help-block"></p>
								 </div> 
							</div>
						...
						<?php
							if(isset($_POST['fromDate']) AND isset($_POST['toDate'])){
									...
									$toDate = $_POST['toDate'];
									listPaymentVendors($fromDate,$toDate);
							}else{
									listPaymentVendors(0,0);
