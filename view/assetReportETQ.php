<?php
	...
	$menu = "assets";
 	$formHeader  = "Subcontractors List";
 ?>
					...
					<div class="panel-body table-responsive" id="page-content"> 
						<div class="form-group dontPrint"> 
        					<div class="col-lg-4 col-md-4 col-sm-4 col-xs-4"> 
								<form method="post" action="excelAssetReportAT.php">
						...
						<table  class="table table-bordered table-hover" id ="example" >
							<thead>
								...
								<tr class="table-header">
									...
									<th class='text-center'>Assets Type</th>
									<th class='text-center'>Currency </th>
									<th class='text-center'>Rate </th>
									<th class='text-center'>Amount</th>
									<th class='text-center'>Amount(USD)</th>
									<th class='text-center'>Bank </th>
									<th class='text-center'>Useful Life (year)</th>
							...
							$counter = $start;
								...
								<tr>
									...
									<td class='text-center'><?php echo $assetRow['name']; ?></td>
									...
									<td class='text-center'><?php echo $row['useful_age']  ?></td>
