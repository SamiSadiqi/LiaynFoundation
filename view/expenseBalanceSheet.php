<?php
	require_once("_header.php");
  	$formHeader  = "Miscellaneous Expenses";
		...
		<div class="main-content">
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-lg-offset-3 col-md-offset-3 col-sm-offset-3">
					<h1 class="text-center"><?php echo $companyName; ?></h1>
						...
						if(!empty($fromDate) && !empty($toDate)){
							$title="Miscellaneous Expenses From <b> ".$fromDate."  </b> to <b>".$toDate."</b>";
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					...
					<?php
						$table      = "tbl_expenses";       
						$targetPage = "expenseBalanceSheet.php";    
						$limit      = 40;  
						if(!empty($fromDate) && !empty($toDate)){
							$rowCountSQL  = $conn->query("SELECT COUNT(*) AS totalRows FROM $table WHERE (date BETWEEN '$fromDate' AND '$toDate') AND  deleted = 0 ORDER BY id DESC");
						}elseif(empty($fromDate) && empty($toDate)){
						...
						//Get Page Data
						if(!empty($fromDate) && !empty($toDate)){
							$dataSql    = "SELECT * FROM $table WHERE (date BETWEEN '$fromDate' AND '$toDate') AND deleted = 0 ORDER BY id DESC LIMIT $start, $limit";
						}elseif(empty($fromDate) && empty($toDate)){
							$dataSql    = "SELECT * FROM $table WHERE deleted = 0 ORDER BY id DESC LIMIT $start, $limit";
						}
						...
						<table  class="table table-bordered table-hover" id ="example" >
							...
							<tbody>
								...
								$serviceProviderId = $row['id'];
									...
									?>
									<tr>
										<td class='text-center' colspan='7' ><b>Total Miscellaneouse Expenses</b></td>
