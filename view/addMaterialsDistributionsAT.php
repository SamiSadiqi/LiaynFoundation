			...
			<div class="col-md-12 col-lg-12 col-sm-12 animatedParent animateOnce z-index-50"> 
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content">
						...
						?>
						<form class="form-horizontal" action="<?php echo getRootModel(); ?>newActionsMaterialsDistributionsAT.php" method="POST">
							
							<input name="formParameter" value="<?php echo encryptIt("tbl_donations_materials_title"); ?>" type="hidden"  />
							...
							<div class="alert alert-info"  style="padding-bottom: 0px;background-color:#00b8ce">
								<div class="form-group">
									...
									<div class="col-lg-3 col-md-3 col-sm-3"> 
										<select class="select2 form-control" name='schoolId' style='font-weight: bold;color:red;' required  autocomplete="off" id='schoolId'>
											<option Value="">انتخاب مکتب</option>
											<?php
											 
											$schoolRow= $conn->query("SELECT * FROM `tbl_schools` WHERE deleted = 0 ORDER BY id DESC");
											while($row = $schoolRow->fetch_array()){
									...
									<div class="col-lg-3 col-md-3 col-sm-3"> 
										<input type="text"  autocomplete="off"  placeholder="شماره درخواست" name='requestNumber'  class="form-control">
										<p class="help-block"></p>
									</div>									
							...
							<div class="alert alert-success col-md-4 col-lg-4 col-xs-12 col-sm-12" style="padding-bottom: 0px;background-color:#00b8ce;">
									...
									<div class="form-group"> 
										<label class="col-lg-4 col-md-4 col-sm-4 col-xs-4  control-label" for="name">کل قیمت اقلام</label> 
										<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12"> 
											<input type="text" placeholder="کل قیمت اقلام"  autocomplete="off" id="totalFactorPrice" name="totalFactorPrice" class="form-control p-number">
											<p class="help-block"></p>
										</div> 
									</div> 
									...
									<div class="form-group"> 
										<label class="col-lg-4 col-md-4 col-sm-4 col-xs-4 control-label" for="factorDescription">توضیحات توزیع</label> 
										<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12"> 
										<textarea    placeholder = "توضیحات توزیع" autocomplete="off" name="factorDescription" name="factorDescription" class="form-control"></textarea>
						...
						<?php
							...
							materialsListDistribution('addMaterialsDistributionsAT.php',$validationEditCondition,$validationRemoveCondition);
						?>
