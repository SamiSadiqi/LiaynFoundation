				...
				<div class="panel panel-primary animated fadeInUp">
					...
					<div class="panel-body" id="page-content"> 
						...
						<form class="form-horizontal"  id="insertForm" method="POST">
							...
							<input name="formTable" value="<?php echo encryptIt("tbl_interface"); ?>" type="hidden"  />
						...
						<?php
							}interfaceList('addInterefaceOrgAT.php',$validationEditCondition,$validationRemoveCondition);
